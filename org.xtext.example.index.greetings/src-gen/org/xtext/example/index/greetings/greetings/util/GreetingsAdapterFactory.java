/**
 */
package org.xtext.example.index.greetings.greetings.util;
 ...
 * @generated
 */
public class GreetingsAdapterFactory extends AdapterFactoryImpl
{
  /**
   ...
   * @generated
   */
  protected static GreetingsPackage modelPackage;
   ...
   * @generated
   */
  public GreetingsAdapterFactory()
  {
    if (modelPackage == null)
    {
      modelPackage = GreetingsPackage.eINSTANCE;
    }
  }
   ...
   * @generated
   */
  protected GreetingsSwitch<Adapter> modelSwitch =
    new GreetingsSwitch<Adapter>()
    {
      @Override
  ...
  /**
   * Creates a new adapter for an object of class '{@link org.xtext.example.index.greetings.greetings.Model <em>Model</em>}'.
   * <!-- begin-user-doc -->
  ...
  /**
   * Creates a new adapter for an object of class '{@link org.xtext.example.index.greetings.greetings.Greeting <em>Greeting</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
