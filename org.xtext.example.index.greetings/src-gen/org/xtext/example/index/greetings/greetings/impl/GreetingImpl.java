 ...
 * <ul>
 *   <li>{@link org.xtext.example.index.greetings.greetings.impl.GreetingImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class GreetingImpl extends MinimalEObjectImpl.Container implements Greeting
{
  ...
  {
    return GreetingsPackage.Literals.GREETING;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, GreetingsPackage.GREETING__NAME, oldName, name));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case GreetingsPackage.GREETING__NAME:
        return getName();
    }
